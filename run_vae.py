...
parser.add_argument('--design', type=str,   default='v2',      help="Architecture design")
...
parser.add_argument('--npc',    type=int,   default=100,       help="Number of samples per class (semi-sup)")
